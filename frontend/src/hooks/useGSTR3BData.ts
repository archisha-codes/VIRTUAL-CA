    ...
    queryFn: async (): Promise<GSTR3BData | null> => {
      ...
      try {
        ...
        if (response.success && response.data?.gstr3b_data) {
          ...
          return {
            outwardSupplies: {
              taxableSupplies: backendData.outwardSupplies?.taxableSupplies || { taxableValue: 0, igst: 0, cgst: 0, sgst: 0, cess: 0 },
              zeroRatedSupplies: backendData.outwardSupplies?.zeroRatedSupplies || { taxableValue: 0, igst: 0, cgst: 0, sgst: 0, cess: 0 },
              nilRatedSupplies: { taxableValue: 0, igst: 0, cgst: 0, sgst: 0, cess: 0 },
              reverseChargeSupplies: backendData.outwardSupplies?.reverseChargeSupplies || { taxableValue: 0, igst: 0, cgst: 0, sgst: 0, cess: 0 },
            ...
            eligibleItc: {
              itcAvailable: backendData.itcAvailable || { igst: 0, cgst: 0, sgst: 0, cess: 0 },
