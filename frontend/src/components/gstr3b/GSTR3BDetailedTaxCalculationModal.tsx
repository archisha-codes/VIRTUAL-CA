...
const GSTR3BDetailedTaxCalculationModal: React.FC<GSTR3BDetailedTaxCalculationModalProps> = ({
  ...
  const [values, setValues] = useState<Record<string, Record<string, number>>>({
    clear_gst: {
      "row5_total": 7942446, "row5_igst": 7888940, "row5_cgst": 26753, "row5_sgst": 26753, "row5_cess": 0,
      "row20_total": 7942446, "row20_igst": 7888940, "row20_cgst": 26753, "row20_sgst": 26753, "row20_cess": 0,
    },
    govt: {
      "row5_total": 7942446, "row5_igst": 7888940, "row5_cgst": 26753, "row5_sgst": 26753, "row5_cess": 0,
    },
