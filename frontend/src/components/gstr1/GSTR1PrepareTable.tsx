...
export default function GSTR1PrepareTable({
  ...
  const calculateBusinessTotals = (business: GSTR1BusinessData) => {
    return business.gstins.reduce((acc, gstin) => ({
      docCount: acc.docCount + gstin.docCount,
      taxableAmount: acc.taxableAmount + gstin.taxableAmount,
      totalTax: acc.totalTax + gstin.totalTax,
      igst: acc.igst + gstin.igst,
      cgst: acc.cgst + gstin.cgst,
      sgst: acc.sgst + gstin.sgst,
      cess: acc.cess + gstin.cess,
    }), {
      docCount: 0,
      taxableAmount: 0,
      totalTax: 0,
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="flex flex-col">
                              ...
                              <button 
                                ...
                                className="text-xs text-blue-600 font-semibold text-left uppercase hover:underline mt-1 focus:outline-none"
                              >
                                View Sections
                              </button>
                            </div>
