...
from india_compliance.gst_india.utils.frappe_replacements import throw, _
...
class EInvoiceAPI(TaxpayerBaseAPI):
    ...
    def setup(self, doc=None, *, company_gstin=None):
        ...
        if self.sandbox_mode:
            throw(_("Sandbox mode is not supported for Taxpayer e-Invoice API"))

        if not company_gstin:
            throw(_("Company GSTIN is required to use the e-Invoice API"))
