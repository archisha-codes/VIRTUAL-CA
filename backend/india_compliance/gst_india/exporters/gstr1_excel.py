...
def export_gstr1_excel(clean_data, return_period, taxpayer_gstin, taxpayer_name):
    """
...
def export_gstr1_excel_direct(gstr1_tables, return_period, taxpayer_gstin, taxpayer_name):
    """
